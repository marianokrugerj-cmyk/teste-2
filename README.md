...
while wait() do
    for i,v in pairs(game:GetService("Workspace")["_WorldOrigin"]:GetChildren()) do
        pcall(function()
            if v.Name == ("CurvedRing") or v.Name == ("TUTU shHit") or v.Name == ("SwordTUTU sh") or v.Name == ("TUTU shTail") or v.Name == ("Sounds") then
                v:Destroy()
            end
        end)
    end
...
local Window = OrionLib:MakeWindow({Name = "TUTU  Hub", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "TUTU  Hub"})
